...
public class TreeMap01 {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        /*
        If the "key" inside the ceilingEntry() method parenthesis is ths same with any key inside the TreeMap,
        ...
        */
        ...
        /*lowerEntry("Germany") method gives the previous entry under every condition but
        floorEntry("Germany") method gives the same entry for the existing keys
