...
//           [2, 3, 2, 2, 5] ==> [2, 3, 5]
        ...
        // Ask user to enter a letter, if the letter exist inside the list convert the element to "Got it"
...
//      ii) Use contains()
        ...
        int h = d.lastIndexOf("Rs"); // gives you the index of last occurrence of a specific element
