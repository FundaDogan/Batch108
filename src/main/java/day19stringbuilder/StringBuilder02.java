...
public class StringBuilder02 {
    public static void main(String[] args) {
        ...
        // append metodu stringBuilderi degistiriyor ve her tur data eklenebiliyor.


        // toString method is used to change StringBuilders to string
       String s = sb1.toString();

       // s = String,   sb1= StringBuilder
