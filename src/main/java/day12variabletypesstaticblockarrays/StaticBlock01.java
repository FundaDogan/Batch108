...
public class StaticBlock01 {
    ...
    /*
        ...
        6)"static block" is used to initialize(assigning first value) "static variables" in the INTERVIEW we can say this
    ...
    */
    ...
    public static double pi;  //default value 0.0 because it is double
