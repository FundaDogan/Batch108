...
public class VariableTypes01 {
    ...
    // sout main metod olmadigi icin burda yazilamiyo bile. soutu yazman icin bir metod gerekli
    // add ve multiply metodunun icine yaziliyo ama main metod olmadigi icin run etme butonu bile yok.
