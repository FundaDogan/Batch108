...
public class Runner {
    ...
    public static void main(String[] args) {
      ...
      13)"static" methods cannot be overridden because "static" things are common for
        ...
        // method overriding means dynamic polymorphism, method overloading static polymorphism
 ...
 3) "super" keyword is used to select any variable or any method from parent class==> super(eat);==>cons to parent class
                                                                                      ...
                                                                                      super.x==> variable from parent class
3)"super" keyword is used to select any variable or any method from parent class
  ...
  */
      ...
      /*
        To be able to use overriding we need to create parent-child relation
        ...
        Updating a method after getting from parent class is called "METHOD OVERRIDING".
        To make a general method a specific method is called "method overriding".

        Access modifiers of overriding is same no problem.
        but if private acc. mod. no relation/inheritance. Private access modifier can not be inherited.
