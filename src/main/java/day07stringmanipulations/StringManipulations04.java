...
public class StringManipulations04 {
    ...
    public static void main(String[] args) {
        ...
        // isEmpty() space'i char sayar ve string icinde ise false verir, cunku bos degil
        // isBlank() space'i saymaz ve string icinde ise evet string bos der blank bos anlaminda ya,
        // string'e space koysan bile bos gorunuyor. bu yuzden true verir.
