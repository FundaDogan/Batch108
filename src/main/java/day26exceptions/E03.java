...
public class E03 {
    ...
    //If the path is wrong, if the file doesn't exist, if the text cannot be read,  stop execution
    ...
    // if the file doesn't exist, give a message to the user and do not stop execution
